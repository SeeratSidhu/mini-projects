...
class Fighter extends Sprite {
  constructor({
    ...
    framesMax = 1,
    sprites,
    attackWeapon = { offset: {}, width: undefined, height: undefined}
  }) {
    ...
    this.attackWeapon = {
      ...
      offset: attackWeapon.offset,
      width: attackWeapon.width,
      height: attackWeapon.height,
    };
    this.color = color;
  ...
  update() {
    ...
    this.attackWeapon.position.y = this.position.y + this.attackWeapon.offset.y;
  ...
  switchSprite(sprite) {
    ...
    //override other animations on attack
